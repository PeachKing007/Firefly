...
代码：
    ...
    [id][id]: http://example.com/  "Optional Title Here"
...
代码：
    ...
    [foo]: http://example.com/  'Optional Title Here'
    [foo]: http://example.com/  (Optional Title Here)
    [foo]:[http://example.com/](http://example.com/)  "Optional Title Here"
...
代码：
    ...
    [img id][img id]: https://s2.loli.net/2024/08/20/5fszgXeOxmL3Wdv.webp  "Optional title attribute"
    ![Alt text][img id]
...
[img id]: https://s2.loli.net/2024/08/20/5fszgXeOxmL3Wdv.webp
