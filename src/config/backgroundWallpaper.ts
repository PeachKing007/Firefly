...
export const backgroundWallpaper: BackgroundWallpaperConfig = {
	...
	src: {
		...
		mobile: [
			"assets/images/MobileWallpaper/c1.jpg",
			"assets/images/MobileWallpaper/c2.jpg",
			"assets/images/MobileWallpaper/c3.png",
			"assets/images/MobileWallpaper/c4.jpg",
			"assets/images/MobileWallpaper/c5.jpg",
		],
		// 背景视频播放地址
	...
	common: {
		...
		homeText: {
			...
			switchable: true,
			// 主页横幅主标题
			title: "PeachBlog desu, welcome!",
			// 主页横幅主标题字体大小
			titleSize: "3.8rem",
			// 主页横幅副标题
			subtitle: [
				"Sunk in the Psychology",
				"Fall into the Galgame",
